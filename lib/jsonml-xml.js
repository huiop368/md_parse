 ...
 */
var appendDOM = function appendDOM(elem, child) {
  if (child) {
    if (elem.nodeType === 8) {
      // comment
      if (child.nodeType === 3) {
 ...
 * @return {Node}
 */
var patch = function patch(elem, jml, filter) {
...
var addChildren = function addChildren( /*DOM*/elem, /*function*/filter, /*JsonML*/jml) {
